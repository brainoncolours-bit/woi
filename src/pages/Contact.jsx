...
const RECIPIENT_EMAIL = 'hello@worldofique.com';
    ...
    <div className="min-h-screen bg-[#080808] text-white px-4 pt-28 pb-16 flex flex-col items-center gap-10">
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              href="mailto:hello@worldofique.com"
            ...
            >
              ...
              <p className="text-xs text-white/60 group-hover:text-white/85 transition-colors break-all">hello@worldofique.com</p>
            </a>
            <a
