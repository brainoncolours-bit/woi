...
export default function ContactPage() {
  ...
  const handleSubmit = () => {
    ...
    const subject = encodeURIComponent(
      `[WOI Enquiry] ${form.firstName} ${form.lastName}`.trim()
    );
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-4 hover:border-[#ffb900]/30 hover:bg-[#ffb900]/[0.04] transition-all duration-200 group flex items-center gap-4"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ffb900" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
            </svg>
            <div>
              <p className="text-[10px] uppercase tracking-widest text-white/25 mb-0.5">Email</p>
              <p className="text-sm text-white/60 group-hover:text-white/85 transition-colors">ceo@woi.eco</p>
            </div>
          </a>
